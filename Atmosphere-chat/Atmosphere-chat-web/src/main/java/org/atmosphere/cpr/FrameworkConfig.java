...
/**
 * Request Attribute a framework integrator can use to lookup Atmosphere
 * internal object.
 * 
...
public interface FrameworkConfig {
	...
	/**
	 * A request attribute used to lookup the {@link AtmosphereServlet}. This
	 * attribute is for framework integrator and not recommend for normal
	 * application.
	 */
	String ATMOSPHERE_SERVLET = "org.atmosphere.cpr.AtmosphereServlet";
	/**
	 * A request attribute used to lookup the {@link AtmosphereResource}. This
	 * attribute is for framework integrator and not recommend for normal
	 * application.
	 */
	String ATMOSPHERE_RESOURCE = AtmosphereResource.class.getName();
	/**
	 * A request attribute used to lookup the {@link AtmosphereResource} created
	 * by an external component and injected inside the
	 * {@link AsynchronousProcessor}
	 */
	 ...
	 */
	String SUPPORT_SESSION = AsynchronousProcessor.class.getName()
			+ ".supportSession";
	/**
	 * A request attribute used to lookup the {@link AtmosphereHandler}. This
	 * attribute is for framework integrator and not recommend for normal
	 * application.
	 */
	...
	/**
	 * Used by a Container to tell Atmosphere Runtime what is the expected
	 * content type
	 */
	String EXPECTED_CONTENT_TYPE = FrameworkConfig.class.getName()
			+ ".expectedContentType";
	/**
	...
	/**
	 * Instance of Jersey's ContainerResponseWriter that can be configured by a
	 * Framework running on top of Atmosphere
	 */
	 ...
	 */
	String TRANSPORT_IN_USE = AtmosphereConfig.class.getName()
			+ ".transportUsed";
	/**
	 * Callback hook for Framework implementing Atmosphere support.
	 */
	String ASYNCHRONOUS_HOOK = FrameworkConfig.class.getName()
			+ ".asynchronousProcessorHook";
